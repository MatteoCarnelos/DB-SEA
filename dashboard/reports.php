    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <main role="main" class="col-10 ml-auto px-4">
          ...
          <?php include 'includes/new_report.php' ?>
          ...
          <div class="card">
            ...
            <div id="newReportCollapse" class="collapse <?php if(isset($_GET['new'])) echo 'show' ?>">
              <div class="card-body">
                <form class="needs-validation" method="post" action="reports.php" novalidate>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="input-group col-11">
                      ...
                      <div class="input-group-append">
                        <a class="btn btn-outline-success" href="doctors.php?new">
                  ...
                  <div class="mt-3 form-group row">
                    ...
                    <div class="input-group col-11">
                      ...
                      <div class="input-group-append">
                        <a class="btn btn-outline-success" href="medicines.php?new">
                          <i data-feather="database"></i>
                    ...
                    <div id="symptom">
                      <div class="mt-3 form-group row">
                        ...
                        <div class="input-group col-11">
                          ...
                          <div class="input-group-append">
                            <a class="btn btn-outline-success" href="symptoms.php?new">
                              <i data-feather="database"></i>
